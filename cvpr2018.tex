...
$\mathcal{V}$ is the overall GAN loss, which usually takes the form $\mathbb{E}_{Y\sim p_{data}}\big[\log D(Y)\big] + \mathbb{E}_{\bm z\sim p_{z}}\big[\log (1-D(G(\bm z)))\big]$ or other variations\cite{lsgan}.
